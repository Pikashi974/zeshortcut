  ...
  return (
    <div className="fontFasterStroker bg-slate-50 flex justify-between">
        ...
        <div className="bg-green-50 flex items-end h-screen">
          <img className="h-[90%]" src="public/images/image_result.png" />
        </div>
        ...
        <div className=" flex flex-col justify-center p-4 gap-16 bg-slate-50 pr-20">
          ...
          <div className="flex flex-col gap-4 bg-green-300 items-center h-[90vh] rounded-xl py-10 px-6">
            <p className="text-3xl mb-8 w-[60%] text-center">Vous avez un besoin calorique de</p>
            <p className=" text-6xl text-red-600">2000 Cal</p>
            <p className="text-xl mt-8">Quel est votre objectif ? </p>
            <p className="text-lg text-gray-500">
              Vous recevrez votre régime personalisé par mail
            </p>
            ...
            <div className="flex flex-col gap-10 justify-center items-center">
              <div className="flex hover:scale-105 justify-between gap-2 items-center">
                <img className="w-11" src="public/images/icon1.png" />
                <p className="text-3xl">Perdre du poids</p>
              </div>

              <div className="flex hover:scale-105 justify-between gap-2 items-center">
                <img className="w-11" src="public/images/icon2.png" />
